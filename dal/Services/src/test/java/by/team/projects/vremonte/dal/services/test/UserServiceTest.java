...
import by.team.projects.vremonte.dal.services.UserService;
	...
	public void testUserDelegation() {
		...
		UserService userService = ctxt.getBean(UserService.class);
			...
			CustomerPerson person = new CustomerPerson();
				...
				person = (CustomerPerson) userService.addUser(person);
		...
		Assert.notNull(person, "Couldn't create a Person via CustomerDelegator!");
			...
			CustomerOrganization org = new CustomerOrganization();
				...
				org = (CustomerOrganization) userService.addUser(org);
